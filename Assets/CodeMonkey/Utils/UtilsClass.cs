...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static void CreateWorldTextPopup(Transform parent,string text, Vector3 localPosition, float popupTime = 1f)
        {
            CreateWorldTextPopup(parent, text, localPosition, 1200, Color.red, localPosition + new Vector3(0, 20), popupTime);
        }
        ...
        public static void CreateWorldTextPopup(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, Vector3 finalPopupPosition, float popupTime) {
            ...
            //textMesh.font = GetFont.instance.font;
