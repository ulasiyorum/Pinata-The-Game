...
namespace CodeMonkey {
    ...
    public static class CMDebug {
        ...
        public static void TextPopupMouse(Transform parent,string text, Vector3? offset = null)
        {
            if (offset == null)
            {
                offset = Vector3.one;
            }
            UtilsClass.CreateWorldTextPopup(parent,text, UtilsClass.GetMouseWorldPosition() + (Vector3)offset);
        }
        ...
        public static void TextPopup(Transform parent,string text, Vector3 position, float popupTime = 1f)
        {
            UtilsClass.CreateWorldTextPopup(parent,text,position,popupTime);
        }
